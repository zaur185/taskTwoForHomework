...
public class Table {
    ...
    public void outputTable(Gameplay gameplay) {
        ...
        for (int index = 0; index < gameplay.getStepArrayList().size(); index++) {
            ...
            if (index % 2 != 0) setTable(i,j, 'X');
            else if(index % 2 == 0) setTable(i,j, '0');
            ...
            if (index % 2 != 0) {
                if(checkTablePLayer1()){
                    System.out.println("победил Том");
                }
            }else if(index % 2 == 0){
                if(checkTablePLayer2()){
                    System.out.println("победил Jerry");
                }
            }
